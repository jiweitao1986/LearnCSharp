...
namespace LearnCSharp.Basic.Ds
{
    ...
    /// <remarks>
    /// 《MSDN DataColumn》
    /// https://msdn.microsoft.com/zh-cn/library/system.data.datacolumn.datatype(v=vs.110).aspx
    /// 
    /// 《MSDN DataColumn DataType 》
    /// https://msdn.microsoft.com/zh-cn/library/system.data.datacolumn.datatype(v=vs.110).aspx
    /// 
    /// </remarks>
    public static class DataColumnTest
    {
        ...
        public static void Run()
        {
            ...
            {
                Console.WriteLine(column.GetType().ToString());
            }
        }
